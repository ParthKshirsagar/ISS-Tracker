...
import { View, Text, StyleSheet, Image, ImageBackground, StatusBar, SafeAreaView, Platform } from 'react-native';
    ...
    if(Object.keys(this.state.location).length === 0){
      return(
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <Text style={{fontSize: 35, fontWeight: 'bold'}}>Loading...</Text>
        </View>
      )
    } else {
      return(
